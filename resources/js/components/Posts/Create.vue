<template>
    <form @submit.prevent="storePost(post)">
        ...
        <div class="file-upload">
            ...
            <input @change="post.image = $event.target.files[0]" type="file" id="image" class="file-input"
                accept="image/*" />

            <!-- <input @change="previewImage" type="file" id="image" class="file-input" accept="image/*" /> -->
...
const { storePost, validationErrors,
    isLoading, onFileSelected, onUpload, previewImage } = usePosts()
